...
在 GRE 中：
- 没有引用标识的句子就是作者的判断， 而**只要是作者的判断， 下文是绝对不能反驳的**。
...
- 功能是基于视角与逻辑的
- 做法：找到原文所考的位置， 主要关注该部分信息与主线之间的逻辑关系。

**选句子题**：和信息功能题是对称的。

- 信息功能题是给出句子问功能；
- 选句子题是给出功能选句子。
- 做法仍然是根据功能来判定需要的逻辑， 然后在文章中找到相应的逻辑关系所出现的句子。

### 3.2 主旨类

**主旨题**：主旨题的关键在于不被文章细节干扰。在读文章的时候最重要的一个工作就是删除，删除了不影响文章主线的信息，留下文章的主线。在做主旨题的时候，我们要确保自己只需要考虑这部分主线。然后， 看选项时， 思考三个维度的问题： 

- 视角（文章的观点是谁的）是否吻合文章
- 逻辑类型（文章的观点在干什么）是否符合文章
- 对象（文章的主要讨论对象）是否是文章真正的核心讨论对象

**论证结构题**：这种题就是把文章的主线结构分别复述， 是主旨题和功能题的结合。

### 3.2 事实信息类

   **信息题**

- 答案通常不是原文， 而更重要的是， 这些题是通过细节考主线， 而不是细节本身的意思
- 关注题干的视角， 基于文章主线， **把题干所问的对象放到主线中设计答案**。

**削弱题**：这种题型的本质和信息题一样， 削弱原文观点的就是和原文信息相反的内容。

**态度题**：这种题型考查得最粗， 只需要关注正负态度就好， 不用管具体内容。

**类比题**：这种题型问的是和原文相似的场景， 要找和原文信息关系一致的选项。

**词汇题**：这种题型表面上考查词汇意思， 但其实是考查符合原文语境的替换词， 所以一定不能直接选我们认识的词义， 因为通常考的是多义词。
